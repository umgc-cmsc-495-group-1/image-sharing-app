...
function HootTOS() {
  ...
  return (
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  WHO MAY USE THE SITE>Responsive subtitle1</Typography>
	<Typography
	  variant="body2"
	  align="left"
	  style={{ wordWrap: "break-word" }}
	>
	  You may use the Site only if you agree to the rules outlined by these Terms, and are not a person barred from using or receiving Content through such sites and similar services by law. Additionally, in all cases, you must be at least 13 years old, and must not have previously held an account with the Site which was removed or suspended for violation of these Terms. By creating an account with the Site, you accept these Terms, and confirm to the best of your knowledge that you satisfy all eligibility criteria. Discovery of an account made in violation of these Terms will be cause for immediate suspension.
	>Responsive body2</Typography>
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  PRIVACY>Responsive subtitle2</Typography>
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  CONTENT ON THE SITE>Responsive subtitle3</Typography>
...
You retain all rights to any Content you submit to the Site. All content which you have rights to use, you continue to have those rights with after uploading to the Site. By submitting, posting, uploading or otherwise displaying Content on the Site, you grant the Site a worldwide, non-exclusive, royalty-free license to use, copy, reproduce, adapt, modify, publish, transmit, display, and distribute the Content in-question in any and all media formats now known or later developed. This license (“Service License”) is for the purpose of allowing the Site to make your Content available to other users and vice versa. You agree that this license also allows the Site to provide, promote, and improve the Site as appropriate, without compensation. By uploading this Content, you agree that you have obtained any and all rights, licenses, permissions, and other authority necessary to grant the Service License as described.
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  USER ACCOUNTS>Responsive subtitle4</Typography>
...
hootCustService@gmail.com
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  DISCLAIMERS>Responsive subtitle5</Typography>
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  LIMITATION OF LIABILITY>Responsive subtitle6</Typography>
	...
	<Typography
	  ...
	  style={{ wordWrap: "break-word" }}
	>
	  GENERAL>Responsive subtitle7</Typography>
...
If you are a United States federal, state, or local government agency or body, using the Services in your official capacity, and legally unable to accept the clauses as defined in this section, then this section does not apply to you. For such entities, this agreement and any related section will be governed by the laws of the United States of America, without regard of conflict of law provisions, and, in the absence of federal law and to the extent permitted under Federal law, the State of Maryland, excluding choice of law.
In the event that any provision of the Terms is held to be invalid or unenforceable, that provision will be limited or eliminated to the minimum extent necessary, and the remaining provisions of the Terms will remain in full force and effect. The Site’s failure to enforce any right or provision of these Terms will not be deemed a waiver of such right or provision.
	>Responsive body8</Typography>
